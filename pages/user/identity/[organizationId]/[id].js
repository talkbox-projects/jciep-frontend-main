...
import organizationIdentityGet from "../../../../utils/api/OrganizationIdentityGet";
...
export const getServerSideProps = async (context) => {
  ...
  return {
    props: {
      page,
      api: {
        identity: await organizationIdentityGet({ organizationId: context.query.organizationId, identityId: context.query.id }, context),
      },
